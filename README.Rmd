...
[![CRAN\_Download\_Badge](https://cranlogs.r-pkg.org/badges/gie)](https://cran.r-project.org/package=gie)
<!-- badges: end -->

A R wrapper for Gas Infrastructure Europe's (GIE) AGSI+ and ALSI+ transparency platform API (also supports getting Urgent Market Messages from Inside Information Platform, IIP)
